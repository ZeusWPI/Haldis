...
def addAfhalen():
    ...
    for pizza in pizzaAfhalen.keys:
        entry = Product()
        entry.configure(primadonna_afhalen, pizza, pizzasAfhalen.get(pizza, 0))
        db.session.add(entry)
